"""Item stats builder — fixture baseline (B4)."""
import json, ast, unittest
from pathlib import Path
from app.application.use_cases.report_builders.item_stats import build_item_stats
...
class ItemStatsBuilderTests(unittest.TestCase):
    ...
    def test_matches_fixture(self):
        ...
        rows = build_item_stats(specs_d, results_d)
        expected = json.loads((FIXTURES/"item_stats.json").read_text("utf-8"))
