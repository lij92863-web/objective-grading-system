"""Validation helpers and blocking-error policy."""

from typing import Dict, Iterable

from objective_grader_legacy import build_validation_report, write_validation_report
...
__all__ = ["build_validation_report", "has_blocking_errors", "is_blocking_error", "write_validation_report"]
